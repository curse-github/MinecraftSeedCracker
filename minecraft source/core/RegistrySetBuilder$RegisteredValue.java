...
/*     */   
/* 125 */   private RegisteredValue(T value, Lifecycle lifecycle) { this.value = value; this.lifecycle = lifecycle; } public T value() { return (T)this.value; } public Lifecycle lifecycle() { return this.lifecycle; }
/*     */ }
