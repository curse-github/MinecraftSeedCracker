...
/*    */     //   0	7	0	this	Lnet/minecraft/advancements/criterion/FallAfterExplosionTrigger$TriggerInstance; }
/*    */   
...
/*    */   
/* 28 */   public TriggerInstance(Optional<ContextAwarePredicate> player, Optional<LocationPredicate> startPosition, Optional<DistancePredicate> distance, Optional<ContextAwarePredicate> cause) { this.player = player; this.startPosition = startPosition; this.distance = distance; this.cause = cause; } public Optional<ContextAwarePredicate> player() { return this.player; } public Optional<LocationPredicate> startPosition() { return this.startPosition; } public Optional<DistancePredicate> distance() { return this.distance; } public Optional<ContextAwarePredicate> cause() { return this.cause; }
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\advancements\criterion\FallAfterExplosionTrigger$TriggerInstance.class
