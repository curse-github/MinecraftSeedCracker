...
/*     */     //   0	7	0	this	Lnet/minecraft/advancements/criterion/KilledByArrowTrigger$TriggerInstance; }
/*     */   
...
/*     */   
/*  42 */   public TriggerInstance(Optional<ContextAwarePredicate> player, List<ContextAwarePredicate> victims, MinMaxBounds.Ints uniqueEntityTypes, Optional<ItemPredicate> firedFromWeapon) { this.player = player; this.victims = victims; this.uniqueEntityTypes = uniqueEntityTypes; this.firedFromWeapon = firedFromWeapon; } public Optional<ContextAwarePredicate> player() { return this.player; } public List<ContextAwarePredicate> victims() { return this.victims; } public MinMaxBounds.Ints uniqueEntityTypes() { return this.uniqueEntityTypes; } public Optional<ItemPredicate> firedFromWeapon() { return this.firedFromWeapon; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\advancements\criterion\KilledByArrowTrigger$TriggerInstance.class
