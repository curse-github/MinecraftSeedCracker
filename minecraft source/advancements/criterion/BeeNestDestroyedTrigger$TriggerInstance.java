...
/*    */     //   0	7	0	this	Lnet/minecraft/advancements/criterion/BeeNestDestroyedTrigger$TriggerInstance; }
/*    */   
...
/*    */   
/* 26 */   public TriggerInstance(Optional<ContextAwarePredicate> player, Optional<Holder<Block>> block, Optional<ItemPredicate> item, MinMaxBounds.Ints beesInside) { this.player = player; this.block = block; this.item = item; this.beesInside = beesInside; } public Optional<ContextAwarePredicate> player() { return this.player; } public Optional<Holder<Block>> block() { return this.block; } public Optional<ItemPredicate> item() { return this.item; } public MinMaxBounds.Ints beesInside() { return this.beesInside; }
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\advancements\criterion\BeeNestDestroyedTrigger$TriggerInstance.class
