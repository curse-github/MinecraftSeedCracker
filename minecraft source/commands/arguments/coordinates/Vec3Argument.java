...
/*    */   
/* 24 */   public static final SimpleCommandExceptionType ERROR_NOT_COMPLETE = new SimpleCommandExceptionType(Component.translatable("argument.pos3d.incomplete"));
/* 25 */   public static final SimpleCommandExceptionType ERROR_MIXED_TYPE = new SimpleCommandExceptionType(Component.translatable("argument.pos.mixed"));
/*    */   
/*    */   private final boolean centerCorrect;
/*    */ 
/*    */   
/* 30 */   public Vec3Argument(boolean centerCorrect) { this.centerCorrect = centerCorrect; }
/*    */ 
/*    */ 
/*    */   
/* 34 */   public static Vec3Argument vec3() { return new Vec3Argument(true); }
/*    */ 
/*    */ 
/*    */   
/* 38 */   public static Vec3Argument vec3(boolean centerCorrect) { return new Vec3Argument(centerCorrect); }
/*    */ 
/*    */ 
/*    */   
/* 42 */   public static Vec3 getVec3(CommandContext<CommandSourceStack> context, String name) { return ((Coordinates)context.getArgument(name, Coordinates.class)).getPosition((CommandSourceStack)context.getSource()); }
/*    */ 
/*    */ 
/*    */   
/* 46 */   public static Coordinates getCoordinates(CommandContext<CommandSourceStack> context, String name) { return (Coordinates)context.getArgument(name, Coordinates.class); }
/*    */ 
/*    */ 
/*    */   
...
/*    */ 
/*    */   
/* 79 */   public Collection<String> getExamples() { return EXAMPLES; }
/*    */ }
