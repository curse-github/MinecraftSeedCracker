...
/*     */ 
/*     */   
/* 174 */   public String toString() { return (String)this.version.map(v -> this.name + ":" + this.name).orElse(this.name); }
/*     */ }


/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraf\\util\NativeModuleLister$NativeModuleInfo.class
