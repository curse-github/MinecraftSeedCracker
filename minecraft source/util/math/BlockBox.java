...
public class BlockBox {
    ...
    public Stream<ChunkPos> streamChunkPos() {
        int $$0 = ChunkSectionPos.getSectionCoord(this.getMinX());
        int $$1 = ChunkSectionPos.getSectionCoord(this.getMinZ());
        int $$2 = ChunkSectionPos.getSectionCoord(this.getMaxX());
        int $$3 = ChunkSectionPos.getSectionCoord(this.getMaxZ());
        return ChunkPos.stream(new ChunkPos($$0, $$1), new ChunkPos($$2, $$3));
    }
    ...
    public static Optional<BlockBox> encompassPositions(Iterable<BlockPos> positions) {
        Iterator<BlockPos> $$1 = positions.iterator();
        if (!$$1.hasNext()) {
            return Optional.empty();
        }
        BlockBox $$2 = new BlockBox($$1.next());
        $$1.forEachRemaining($$2::encompass);
        return Optional.of($$2);
    }

    public static Optional<BlockBox> encompass(Iterable<BlockBox> boxes) {
        Iterator<BlockBox> $$1 = boxes.iterator();
        if (!$$1.hasNext()) {
            return Optional.empty();
        }
        BlockBox $$2 = $$1.next();
        BlockBox $$3 = new BlockBox($$2.minX, $$2.minY, $$2.minZ, $$2.maxX, $$2.maxY, $$2.maxZ);
        $$1.forEachRemaining($$3::encompass);
    ...
    public void forEachVertex(Consumer<BlockPos> consumer) {
        BlockPos.Mutable $$1 = new BlockPos.Mutable();
        consumer.accept($$1.set(this.maxX, this.maxY, this.maxZ));
        consumer.accept($$1.set(this.minX, this.maxY, this.maxZ));
        consumer.accept($$1.set(this.maxX, this.minY, this.maxZ));
        consumer.accept($$1.set(this.minX, this.minY, this.maxZ));
        consumer.accept($$1.set(this.maxX, this.maxY, this.minZ));
        consumer.accept($$1.set(this.minX, this.maxY, this.minZ));
        consumer.accept($$1.set(this.maxX, this.minY, this.minZ));
        consumer.accept($$1.set(this.minX, this.minY, this.minZ));
    }
