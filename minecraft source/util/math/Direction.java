...
implements StringIdentifiable {
    ...
    public static Direction[] getEntityFacingOrder(Entity entity) {
        Direction $$17;
        float $$1 = entity.getPitch(1.0f) * ((float)Math.PI / 180);
        float $$2 = -entity.getYaw(1.0f) * ((float)Math.PI / 180);
        float $$3 = MathHelper.sin($$1);
        float $$4 = MathHelper.cos($$1);
        float $$5 = MathHelper.sin($$2);
        float $$6 = MathHelper.cos($$2);
        boolean $$7 = $$5 > 0.0f;
        boolean $$8 = $$3 < 0.0f;
        boolean $$9 = $$6 > 0.0f;
        float $$10 = $$7 ? $$5 : -$$5;
        ...
        if ($$10 > $$12) {
            if ($$11 > $$13) {
                return Direction.listClosest($$16, $$15, $$17);
            }
            if ($$14 > $$11) {
                return Direction.listClosest($$15, $$17, $$16);
            }
            return Direction.listClosest($$15, $$16, $$17);
        }
        if ($$11 > $$14) {
            return Direction.listClosest($$16, $$17, $$15);
        }
        if ($$13 > $$11) {
            return Direction.listClosest($$17, $$15, $$16);
        }
        return Direction.listClosest($$17, $$16, $$15);
    }
    ...
    public static Direction transform(Matrix4fc matrix, Direction direction) {
        Vector3f $$2 = matrix.transformDirection(direction.floatVector, new Vector3f());
        return Direction.getFacing($$2.x(), $$2.y(), $$2.z());
    }
    ...
    public static Direction getFacing(float x, float y, float z) {
        ...
        for (Direction $$5 : ALL) {
            float $$6 = x * (float)$$5.vec3i.getX() + y * (float)$$5.vec3i.getY() + z * (float)$$5.vec3i.getZ();
            if (!($$6 > $$4)) continue;
            $$4 = $$6;
            $$3 = $$5;
        }
    ...
    public static Direction get(AxisDirection direction, Axis axis) {
        for (Direction $$2 : ALL) {
            if ($$2.getDirection() != direction || $$2.getAxis() != axis) continue;
            return $$2;
        }
    ...
    public boolean pointsTo(float yaw) {
        float $$1 = yaw * ((float)Math.PI / 180);
        float $$2 = -MathHelper.sin($$1);
        float $$3 = MathHelper.cos($$1);
        return (float)this.vec3i.getX() * $$2 + (float)this.vec3i.getZ() * $$3 > 0.0f;
    }
    ...
    Predicate<Direction> {
        ...
        private static final /* synthetic */ Type[] directions;

        public static Type[] values() {
            return (Type[])directions.clone();
        }
