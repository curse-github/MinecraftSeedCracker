...
/* 14 */         .createSignatureValidator(), () -> 
/* 15 */         this.profilePublicKey.data().hasExpired(gracePeriod));
/*    */   }
/*    */ 
/*    */ 
/*    */   
/* 20 */   public SignedMessageChain.Decoder createMessageDecoder(UUID profileId) { return (new SignedMessageChain(profileId, this.sessionId)).decoder(this.profilePublicKey); }
/*    */ 
/*    */ 
/*    */   
/* 24 */   public Data asData() { return new Data(this.sessionId, this.profilePublicKey.data()); }
/*    */ 
/*    */ 
/*    */   
/* 28 */   public boolean hasExpired() { return this.profilePublicKey.data().hasExpired(); }
