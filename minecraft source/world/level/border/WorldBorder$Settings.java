...
/*     */     //   0	7	0	this	Lnet/minecraft/world/level/border/WorldBorder$Settings; }
/*     */   
...
/*     */   
/* 556 */   public Settings(double centerX, double centerZ, double damagePerBlock, double safeZone, int warningBlocks, int warningTime, double size, long lerpTime, double lerpTarget) { this.centerX = centerX; this.centerZ = centerZ; this.damagePerBlock = damagePerBlock; this.safeZone = safeZone; this.warningBlocks = warningBlocks; this.warningTime = warningTime; this.size = size; this.lerpTime = lerpTime; this.lerpTarget = lerpTarget; } public double centerX() { return this.centerX; } public double centerZ() { return this.centerZ; } public double damagePerBlock() { return this.damagePerBlock; } public double safeZone() { return this.safeZone; } public int warningBlocks() { return this.warningBlocks; } public int warningTime() { return this.warningTime; } public double size() { return this.size; } public long lerpTime() { return this.lerpTime; } public double lerpTarget() { return this.lerpTarget; }
