...
/*     */ {
/*  57 */   static Aquifer create(NoiseChunk noiseChunk, ChunkPos pos, NoiseRouter router, PositionalRandomFactory positionalRandomFactory, int minBlockY, int yBlockSize, FluidPicker fluidRule) { return new NoiseBasedAquifer(noiseChunk, pos, router, positionalRandomFactory, minBlockY, yBlockSize, fluidRule); }
/*     */ 
/*     */   
...
/*     */     } }
/*     */   public static final class FluidStatus extends Record { private final int fluidLevel; private final BlockState fluidType;
/*     */     
...
/*     */       //   0	7	0	this	Lnet/minecraft/world/level/levelgen/Aquifer$FluidStatus; }
/*     */     
/* 737 */     public FluidStatus(int fluidLevel, BlockState fluidType) { this.fluidLevel = fluidLevel; this.fluidType = fluidType; } public final boolean equals(Object o) { // Byte code:
/*     */       //   0: aload_0
/*     */       //   1: aload_1
...
/* 737 */       //   0	8	1	o	Ljava/lang/Object; } public int fluidLevel() { return this.fluidLevel; } public BlockState fluidType() { return this.fluidType; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
