...
/*    */ {
/*    */   static <C extends FeatureConfiguration> PieceGeneratorSupplier<C> simple(Predicate<Context<C>> check, PieceGenerator<C> generator) {
/* 24 */     Optional<PieceGenerator<C>> result = Optional.of(generator);
/* 25 */     return context -> check.test(context) ? result : Optional.empty();
/*    */   }
/*    */   Optional<PieceGenerator<C>> createGenerator(Context<C> paramContext);
/*    */   
/* 29 */   static <C extends FeatureConfiguration> Predicate<Context<C>> checkForBiomeOnTop(Heightmap.Types type) { return context -> context.validBiomeOnTop(type); }
/*    */   public static final class Context<C extends FeatureConfiguration> extends Record { private final ChunkGenerator chunkGenerator; private final BiomeSource biomeSource; private final RandomState randomState; private final long seed; private final ChunkPos chunkPos;
/*    */     
/* 32 */     public Context(ChunkGenerator chunkGenerator, BiomeSource biomeSource, RandomState randomState, long seed, ChunkPos chunkPos, C config, LevelHeightAccessor heightAccessor, Predicate<Holder<Biome>> validBiome, StructureTemplateManager structureTemplateManager, RegistryAccess registryAccess) { this.chunkGenerator = chunkGenerator; this.biomeSource = biomeSource; this.randomState = randomState; this.seed = seed; this.chunkPos = chunkPos; this.config = config; this.heightAccessor = heightAccessor; this.validBiome = validBiome; this.structureTemplateManager = structureTemplateManager; this.registryAccess = registryAccess; } private final C config; private final LevelHeightAccessor heightAccessor; private final Predicate<Holder<Biome>> validBiome; private final StructureTemplateManager structureTemplateManager; private final RegistryAccess registryAccess; public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       //   0	7	0	this	Lnet/minecraft/world/level/levelgen/structure/pieces/PieceGeneratorSupplier$Context<TC;>; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable type table:
/*    */       //   start	length	slot	name	signature
/*    */       //   0	7	0	this	Lnet/minecraft/world/level/levelgen/structure/pieces/PieceGeneratorSupplier$Context<TC;>; } public final boolean equals(Object o) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
