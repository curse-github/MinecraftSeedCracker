...
/*     */   
/* 213 */   public VisitedEntry(LootDataType<T> type, T value) { this.type = type; this.value = value; } public LootDataType<T> type() { return this.type; } public T value() { return (T)this.value; }
/*     */ }
