...
/*     */     //   0	7	0	this	Lnet/minecraft/world/item/alchemy/PotionBrewing$Mix<TT;>; }
/*     */   
...
/*     */     // Local variable type table:
/*     */     //   start	length	slot	name	signature
/*     */     //   0	8	0	this	Lnet/minecraft/world/item/alchemy/PotionBrewing$Mix<TT;>; }
/*     */   
/* 282 */   private Mix(Holder<T> from, Ingredient ingredient, Holder<T> to) { this.from = from; this.ingredient = ingredient; this.to = to; } public Holder<T> from() { return this.from; } public Ingredient ingredient() { return this.ingredient; } public Holder<T> to() { return this.to; }
/*     */ }
