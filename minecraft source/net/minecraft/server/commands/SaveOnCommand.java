...
/* 12 */   private static final SimpleCommandExceptionType ERROR_ALREADY_ON = new SimpleCommandExceptionType(Component.translatable("commands.save.alreadyOn"));
/*    */   
...
/* 20 */             boolean success = source.getServer().setAutoSave(true);
/* 21 */             if (!success) {
/* 22 */               throw ERROR_ALREADY_ON.create();
/*    */             }
