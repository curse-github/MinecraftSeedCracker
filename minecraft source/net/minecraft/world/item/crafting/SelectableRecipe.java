...
/*    */   
/* 15 */   public SelectableRecipe(SlotDisplay optionDisplay, Optional<RecipeHolder<T>> recipe) { this.optionDisplay = optionDisplay; this.recipe = recipe; } public final String toString() { // Byte code:
/*    */     //   0: aload_0
...
/* 15 */     //   0	7	0	this	Lnet/minecraft/world/item/crafting/SelectableRecipe<TT;>; } public SlotDisplay optionDisplay() { return this.optionDisplay; } public final int hashCode() { // Byte code:
/*    */     //   0: aload_0
...
/*    */     // Local variable type table:
/*    */     //   start	length	slot	name	signature
/*    */     //   0	7	0	this	Lnet/minecraft/world/item/crafting/SelectableRecipe<TT;>; } public final boolean equals(Object o) { // Byte code:
/*    */     //   0: aload_0
/*    */     //   1: aload_1
...
/*    */     // Local variable type table:
/*    */     //   start	length	slot	name	signature
/* 15 */     //   0	8	0	this	Lnet/minecraft/world/item/crafting/SelectableRecipe<TT;>; } public Optional<RecipeHolder<T>> recipe() { return this.recipe; }
/*    */   public static <T extends Recipe<?>> StreamCodec<RegistryFriendlyByteBuf, SelectableRecipe<T>> noRecipeCodec() {
/* 17 */     return StreamCodec.composite(SlotDisplay.STREAM_CODEC, SelectableRecipe::optionDisplay, slotDisplay -> 
/*    */         
/* 19 */         new SelectableRecipe(slotDisplay, Optional.empty()));
/*    */   }
/*    */   public static final class SingleInputEntry<T extends Recipe<?>> extends Record { private final Ingredient input; private final SelectableRecipe<T> recipe;
/*    */     
...
/*    */       // Local variable type table:
/*    */       //   start	length	slot	name	signature
/* 33 */       //   0	8	0	this	Lnet/minecraft/world/item/crafting/SelectableRecipe$SingleInputSet<TT;>; } public List<SelectableRecipe.SingleInputEntry<T>> entries() { return this.entries; }
/*    */     
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\world\item\crafting\SelectableRecipe.class
