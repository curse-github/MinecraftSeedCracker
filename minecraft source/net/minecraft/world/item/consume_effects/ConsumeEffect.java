...
/*    */ {
/* 17 */   public static final Codec<ConsumeEffect> CODEC = BuiltInRegistries.CONSUME_EFFECT_TYPE.byNameCodec().dispatch(ConsumeEffect::getType, Type::codec);
/* 18 */   public static final StreamCodec<RegistryFriendlyByteBuf, ConsumeEffect> STREAM_CODEC = ByteBufCodecs.registry(Registries.CONSUME_EFFECT_TYPE).dispatch(ConsumeEffect::getType, Type::streamCodec);
/*    */   Type<? extends ConsumeEffect> getType();
/*    */   boolean apply(Level paramLevel, ItemStack paramItemStack, LivingEntity paramLivingEntity);
/*    */   
/*    */   public static final class Type<T extends ConsumeEffect> extends Record { private final MapCodec<T> codec;
/*    */     private final StreamCodec<RegistryFriendlyByteBuf, T> streamCodec;
/*    */     
/* 25 */     public Type(MapCodec<T> codec, StreamCodec<RegistryFriendlyByteBuf, T> streamCodec) { this.codec = codec; this.streamCodec = streamCodec; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/* 25 */       //   0	7	0	this	Lnet/minecraft/world/item/consume_effects/ConsumeEffect$Type<TT;>; } public MapCodec<T> codec() { return this.codec; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable type table:
/*    */       //   start	length	slot	name	signature
/*    */       //   0	7	0	this	Lnet/minecraft/world/item/consume_effects/ConsumeEffect$Type<TT;>; } public final boolean equals(Object o) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
...
/*    */       // Local variable type table:
/*    */       //   start	length	slot	name	signature
/* 25 */       //   0	8	0	this	Lnet/minecraft/world/item/consume_effects/ConsumeEffect$Type<TT;>; } public StreamCodec<RegistryFriendlyByteBuf, T> streamCodec() { return this.streamCodec; }
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\world\item\consume_effects\ConsumeEffect.class
