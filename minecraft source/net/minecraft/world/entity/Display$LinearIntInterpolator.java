...
/*     */   
/* 951 */   private LinearIntInterpolator(int previous, int current) { this.previous = previous; this.current = current; } public int previous() { return this.previous; } public int current() { return this.current; }
/*     */ 
/*     */   
