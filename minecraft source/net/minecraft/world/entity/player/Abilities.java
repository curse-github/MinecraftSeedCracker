...
/*    */ 
/*    */   
/* 24 */   public float getFlyingSpeed() { return this.flyingSpeed; }
/*    */ 
/*    */ 
/*    */   
/* 28 */   public void setFlyingSpeed(float value) { this.flyingSpeed = value; }
/*    */ 
/*    */ 
/*    */   
/* 32 */   public float getWalkingSpeed() { return this.walkingSpeed; }
/*    */ 
/*    */ 
/*    */   
/* 36 */   public void setWalkingSpeed(float value) { this.walkingSpeed = value; }
/*    */ 
/*    */ 
/*    */   
/* 40 */   public Packed pack() { return new Packed(this.invulnerable, this.flying, this.mayfly, this.instabuild, this.mayBuild, this.flyingSpeed, this.walkingSpeed); }
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/*    */   }
/*    */   public static final class Packed extends Record { private final boolean invulnerable; private final boolean flying; private final boolean mayFly;
/* 61 */     public Packed(boolean invulnerable, boolean flying, boolean mayFly, boolean instabuild, boolean mayBuild, float flyingSpeed, float walkingSpeed) { this.invulnerable = invulnerable; this.flying = flying; this.mayFly = mayFly; this.instabuild = instabuild; this.mayBuild = mayBuild; this.flyingSpeed = flyingSpeed; this.walkingSpeed = walkingSpeed; } private final boolean instabuild; private final boolean mayBuild; private final float flyingSpeed; private final float walkingSpeed; public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       //   0	7	0	this	Lnet/minecraft/world/entity/player/Abilities$Packed; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/* 61 */       //   0	8	1	o	Ljava/lang/Object; } public boolean invulnerable() { return this.invulnerable; } public boolean flying() { return this.flying; } public boolean mayFly() { return this.mayFly; } public boolean instabuild() { return this.instabuild; } public boolean mayBuild() { return this.mayBuild; } public float flyingSpeed() { return this.flyingSpeed; } public float walkingSpeed() { return this.walkingSpeed; }
/*    */ 
/*    */ 
/*    */ 
/*    */ 
