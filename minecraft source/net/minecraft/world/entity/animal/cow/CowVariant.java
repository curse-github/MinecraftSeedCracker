...
/*    */ 
/*    */ public final class CowVariant extends Record implements PriorityProvider<SpawnContext, SpawnCondition> {
...
/*    */ 
/*    */   
/* 25 */   public static final Codec<CowVariant> DIRECT_CODEC = RecordCodecBuilder.create(i -> i.group(
/* 26 */         ModelAndTexture.codec(ModelType.CODEC, ModelType.NORMAL).forGetter(CowVariant::modelAndTexture), SpawnPrioritySelectors.CODEC
/* 27 */         .fieldOf("spawn_conditions").forGetter(CowVariant::spawnConditions))
/* 28 */       .apply(i, CowVariant::new));
/*    */ 
/*    */   
/* 31 */   public static final Codec<CowVariant> NETWORK_CODEC = RecordCodecBuilder.create(i -> i.group(
/* 32 */         ModelAndTexture.codec(ModelType.CODEC, ModelType.NORMAL).forGetter(CowVariant::modelAndTexture))
/* 33 */       .apply(i, CowVariant::new));
/*    */   
/* 35 */   public static final Codec<Holder<CowVariant>> CODEC = RegistryFixedCodec.create(Registries.COW_VARIANT);
/* 36 */   public static final StreamCodec<RegistryFriendlyByteBuf, Holder<CowVariant>> STREAM_CODEC = ByteBufCodecs.holderRegistry(Registries.COW_VARIANT);
/*    */ 
/*    */   
/* 39 */   private CowVariant(ModelAndTexture<ModelType> assetInfo) { this(assetInfo, SpawnPrioritySelectors.EMPTY); }
/*    */ 
/*    */ 
/*    */ 
/*    */   
...
/* 48 */     NORMAL("normal"),
/* 49 */     COLD("cold"),
/* 50 */     WARM("warm"); public static final Codec<ModelType> CODEC; private final String name;
/*    */     static  {
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\world\entity\animal\cow\CowVariant.class
