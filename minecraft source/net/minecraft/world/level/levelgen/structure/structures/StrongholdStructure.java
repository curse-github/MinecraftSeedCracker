...
public class StrongholdStructure extends Structure {
    ...
    private static void generatePieces(StructurePiecesBuilder builder, Structure.GenerationContext context) {
        ...
        do {
            builder.clear();
            context.random().setLargeFeatureSeed(context.seed() + tries++, (context.chunkPos()).x,
                    (context.chunkPos()).z);
            StrongholdPieces.resetPieces();
            startRoom = new StrongholdPieces.StartPiece(context.random(), context.chunkPos().getBlockX(2),
            ...
            builder.moveBelowSeaLevel(context.chunkGenerator().getSeaLevel(), context.chunkGenerator().getMinY(),
                    context.random(), 10);
