...
/*     */   
/* 102 */   private EffectEntry(Holder<MobEffect> effect, NumberProvider duration) { this.effect = effect; this.duration = duration; } public Holder<MobEffect> effect() { return this.effect; } public NumberProvider duration() { return this.duration; }
