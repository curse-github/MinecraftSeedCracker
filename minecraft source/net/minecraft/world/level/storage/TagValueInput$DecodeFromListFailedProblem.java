...
/*     */ 
/*     */ 
/*     */ public final class DecodeFromListFailedProblem
/*     */   extends Record
...
/*     */     //   0	7	0	this	Lnet/minecraft/world/level/storage/TagValueInput$DecodeFromListFailedProblem; }
/*     */   
...
/*     */   
/* 411 */   public DecodeFromListFailedProblem(String name, int index, Tag tag, DataResult.Error<?> error) { this.name = name; this.index = index; this.tag = tag; this.error = error; } public String name() { return this.name; } public int index() { return this.index; } public Tag tag() { return this.tag; } public DataResult.Error<?> error() { return this.error; }
/*     */ 
/*     */   
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\world\level\storage\TagValueInput$DecodeFromListFailedProblem.class
