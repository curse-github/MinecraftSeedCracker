...
/* 22 */     //   0	7	0	this	Lnet/minecraft/core/component/predicates/AttributeModifiersPredicate; } public Optional<CollectionPredicate<ItemAttributeModifiers.Entry, EntryPredicate>> modifiers() { return this.modifiers; }
...
/*    */     // Local variable table:
/*    */     //   start	length	slot	name	descriptor
/*    */     //   0	7	0	this	Lnet/minecraft/core/component/predicates/AttributeModifiersPredicate; }
...
/*    */   public static final class EntryPredicate extends Record implements Predicate<ItemAttributeModifiers.Entry> { private final Optional<HolderSet<Attribute>> attribute; private final Optional<Identifier> id; private final MinMaxBounds.Doubles amount; private final Optional<AttributeModifier.Operation> operation; private final Optional<EquipmentSlotGroup> slot;
/* 26 */     public EntryPredicate(Optional<HolderSet<Attribute>> attribute, Optional<Identifier> id, MinMaxBounds.Doubles amount, Optional<AttributeModifier.Operation> operation, Optional<EquipmentSlotGroup> slot) { this.attribute = attribute; this.id = id; this.amount = amount; this.operation = operation; this.slot = slot; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/*    */ 
/*    */   
/* 67 */   public static final Codec<AttributeModifiersPredicate> CODEC = RecordCodecBuilder.create(i -> i.group(
/* 68 */         CollectionPredicate.codec(EntryPredicate.CODEC).optionalFieldOf("modifiers").forGetter(AttributeModifiersPredicate::modifiers))
/* 69 */       .apply(i, AttributeModifiersPredicate::new));
/*    */ 
/*    */ 
/*    */   
/* 73 */   public DataComponentType<ItemAttributeModifiers> componentType() { return DataComponents.ATTRIBUTE_MODIFIERS; }
/*    */ 
/*    */ 
/*    */   
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\core\component\predicates\AttributeModifiersPredicate.class
