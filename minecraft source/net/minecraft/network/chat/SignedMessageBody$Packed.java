...
/*    */   
/* 43 */   public Packed(String content, Instant timeStamp, long salt, LastSeenMessages.Packed lastSeen) { this.content = content; this.timeStamp = timeStamp; this.salt = salt; this.lastSeen = lastSeen; } public String content() { return this.content; } public Instant timeStamp() { return this.timeStamp; } public long salt() { return this.salt; } public LastSeenMessages.Packed lastSeen() { return this.lastSeen; }
/*    */   
