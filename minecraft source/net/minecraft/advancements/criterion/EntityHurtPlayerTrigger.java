...
/*    */ 
/*    */   
/* 19 */   public void trigger(ServerPlayer player, DamageSource source, float originalDamage, float actualDamage, boolean blocked) { trigger(player, t -> t.matches(player, source, originalDamage, actualDamage, blocked)); }
/*    */   public static final class TriggerInstance extends Record implements SimpleCriterionTrigger.SimpleInstance { private final Optional<ContextAwarePredicate> player; private final Optional<DamagePredicate> damage;
/*    */     
/* 22 */     public TriggerInstance(Optional<ContextAwarePredicate> player, Optional<DamagePredicate> damage) { this.player = player; this.damage = damage; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/* 22 */       //   0	7	0	this	Lnet/minecraft/advancements/criterion/EntityHurtPlayerTrigger$TriggerInstance; } public Optional<ContextAwarePredicate> player() { return this.player; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable table:
/*    */       //   start	length	slot	name	descriptor
/*    */       //   0	7	0	this	Lnet/minecraft/advancements/criterion/EntityHurtPlayerTrigger$TriggerInstance; } public final boolean equals(Object o) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
...
/* 22 */       //   0	8	1	o	Ljava/lang/Object; } public Optional<DamagePredicate> damage() { return this.damage; }
/*    */ 
/*    */ 
/*    */     
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\advancements\criterion\EntityHurtPlayerTrigger.class
