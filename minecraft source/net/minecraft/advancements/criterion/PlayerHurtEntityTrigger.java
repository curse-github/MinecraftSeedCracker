...
/* 21 */     LootContext victimContext = EntityPredicate.createContext(player, victim);
/* 22 */     trigger(player, t -> t.matches(player, victimContext, source, originalDamage, actualDamage, blocked));
/*    */   }
/*    */   public static final class TriggerInstance extends Record implements SimpleCriterionTrigger.SimpleInstance { private final Optional<ContextAwarePredicate> player; private final Optional<DamagePredicate> damage; private final Optional<ContextAwarePredicate> entity;
/* 25 */     public TriggerInstance(Optional<ContextAwarePredicate> player, Optional<DamagePredicate> damage, Optional<ContextAwarePredicate> entity) { this.player = player; this.damage = damage; this.entity = entity; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/* 25 */       //   0	7	0	this	Lnet/minecraft/advancements/criterion/PlayerHurtEntityTrigger$TriggerInstance; } public Optional<ContextAwarePredicate> player() { return this.player; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable table:
/*    */       //   start	length	slot	name	descriptor
/*    */       //   0	7	0	this	Lnet/minecraft/advancements/criterion/PlayerHurtEntityTrigger$TriggerInstance; } public final boolean equals(Object o) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
...
/* 25 */       //   0	8	1	o	Ljava/lang/Object; } public Optional<DamagePredicate> damage() { return this.damage; } public Optional<ContextAwarePredicate> entity() { return this.entity; }
/*    */ 
/*    */ 
/*    */ 
/*    */     
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\advancements\criterion\PlayerHurtEntityTrigger.class
