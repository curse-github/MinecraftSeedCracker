...
/*    */     // Local variable table:
/*    */     //   start	length	slot	name	descriptor
/*    */     //   0	7	0	this	Lnet/minecraft/advancements/criterion/MobEffectsPredicate; }
...
/*    */ 
/*    */   
/* 22 */   public boolean matches(Entity entity) { if (entity instanceof LivingEntity) { LivingEntity living = (LivingEntity)entity; if (matches(living.getActiveEffectsMap())); }  return false; }
/*    */ 
/*    */ 
/*    */   
/* 26 */   public boolean matches(LivingEntity entity) { return matches(entity.getActiveEffectsMap()); }
/*    */ 
/*    */   
...
/* 31 */       MobEffectInstance instance = (MobEffectInstance)effects.get(entry.getKey());
...
/*    */   public static final class MobEffectInstancePredicate extends Record { private final MinMaxBounds.Ints amplifier; private final MinMaxBounds.Ints duration; private final Optional<Boolean> ambient;
...
/*    */       // Local variable table:
/*    */       //   start	length	slot	name	descriptor
/* 62 */       //   0	7	0	this	Lnet/minecraft/advancements/criterion/MobEffectsPredicate$MobEffectInstancePredicate; } public MinMaxBounds.Ints amplifier() { return this.amplifier; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/* 62 */       //   0	8	1	o	Ljava/lang/Object; } public MinMaxBounds.Ints duration() { return this.duration; } public Optional<Boolean> ambient() { return this.ambient; } public Optional<Boolean> visible() { return this.visible; }
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\advancements\criterion\MobEffectsPredicate.class
