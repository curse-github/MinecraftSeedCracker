...
/*    */     //   0	7	0	this	Lnet/minecraft/advancements/criterion/ChangeDimensionTrigger$TriggerInstance; }
/*    */   
...
/*    */   
/* 24 */   public TriggerInstance(Optional<ContextAwarePredicate> player, Optional<ResourceKey<Level>> from, Optional<ResourceKey<Level>> to) { this.player = player; this.from = from; this.to = to; } public Optional<ContextAwarePredicate> player() { return this.player; } public Optional<ResourceKey<Level>> from() { return this.from; } public Optional<ResourceKey<Level>> to() { return this.to; }
/*    */ 
/*    */ 
/*    */ 
/*    */   
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\advancements\criterion\ChangeDimensionTrigger$TriggerInstance.class
