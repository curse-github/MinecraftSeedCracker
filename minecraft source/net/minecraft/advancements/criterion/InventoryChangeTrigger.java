...
/*     */ 
/*     */   
/*  45 */   private void trigger(ServerPlayer player, Inventory inventory, ItemStack changedItem, int slotsFull, int slotsEmpty, int slotsOccupied) { trigger(player, t -> t.matches(inventory, changedItem, slotsFull, slotsEmpty, slotsOccupied)); }
/*     */   public static final class TriggerInstance extends Record implements SimpleCriterionTrigger.SimpleInstance { private final Optional<ContextAwarePredicate> player; private final Slots slots; private final List<ItemPredicate> items;
/*     */     
...
/*     */       //   0	7	0	this	Lnet/minecraft/advancements/criterion/InventoryChangeTrigger$TriggerInstance; } public final int hashCode() { // Byte code:
/*     */       //   0: aload_0
...
/* 126 */           return false;
/*     */         }
/* 128 */         return true; } } } public static final class Slots extends Record { public boolean matches(int slotsFull, int slotsEmpty, int slotsOccupied) { if (!this.full.matches(slotsFull)) return false;  if (!this.empty.matches(slotsEmpty)) return false;  if (!this.occupied.matches(slotsOccupied)) return false;  return true; }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Slots(MinMaxBounds.Ints occupied, MinMaxBounds.Ints full, MinMaxBounds.Ints empty) { this.occupied = occupied;
/*     */       this.full = full;
/*     */       this.empty = empty; }
/*     */     
...
/*     */     
/*     */     public MinMaxBounds.Ints occupied() { return this.occupied; }
/*     */     
/*     */     public MinMaxBounds.Ints full() { return this.full; }
/*     */     
/*     */     public MinMaxBounds.Ints empty() { return this.empty; }
/*     */     
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\advancements\criterion\InventoryChangeTrigger.class
