...
/*    */ 
/*    */   
/* 20 */   public void trigger(ServerPlayer player, ResourceKey<LootTable> lootTable) { trigger(player, t -> t.matches(lootTable)); }
/*    */   public static final class TriggerInstance extends Record implements SimpleCriterionTrigger.SimpleInstance { private final Optional<ContextAwarePredicate> player; private final ResourceKey<LootTable> lootTable;
/*    */     
/* 23 */     public TriggerInstance(Optional<ContextAwarePredicate> player, ResourceKey<LootTable> lootTable) { this.player = player; this.lootTable = lootTable; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/* 23 */       //   0	7	0	this	Lnet/minecraft/advancements/criterion/LootTableTrigger$TriggerInstance; } public Optional<ContextAwarePredicate> player() { return this.player; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable table:
/*    */       //   start	length	slot	name	descriptor
/*    */       //   0	7	0	this	Lnet/minecraft/advancements/criterion/LootTableTrigger$TriggerInstance; } public final boolean equals(Object o) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
...
/* 23 */       //   0	8	1	o	Ljava/lang/Object; } public ResourceKey<LootTable> lootTable() { return this.lootTable; }
/*    */ 
/*    */ 
/*    */     
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\advancements\criterion\LootTableTrigger.class
