...
/*    */ {
/* 16 */   public V3685(int versionKey, Schema parent) { super(versionKey, parent); }
/*    */ 
/*    */   
...
/* 28 */     Map<String, Supplier<TypeTemplate>> map = super.registerEntities(schema);
/* 29 */     schema.register(map, "minecraft:trident", () -> abstractArrow(schema));
