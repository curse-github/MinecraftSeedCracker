...
/* 22 */     .build();
/*    */   
/* 24 */   public static final Map<String, String> RENAMED_BLOCKS = ImmutableMap.builder()
...
/* 39 */     .build();
/*    */   
/* 41 */   public static final Map<String, String> RENAMED_ITEMS = ImmutableMap.builder()
...
/*    */ 
/*    */   
/* 52 */   public EntityTheRenameningFix(Schema schema, boolean changesType) { super("EntityTheRenameningBlock", schema, changesType); }
/*    */ 
/*    */ 
/*    */ 
/*    */   
/*    */   protected String rename(String name) {
/* 58 */     if (name.startsWith("minecraft:bred_")) {
/* 59 */       name = "minecraft:" + name.substring("minecraft:bred_".length());
/*    */     }
/* 61 */     return (String)RENAMED_IDS.getOrDefault(name, name);
/*    */   }
/*    */ }
