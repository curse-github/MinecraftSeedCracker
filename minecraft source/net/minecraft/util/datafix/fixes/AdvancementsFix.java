...
/*  9 */   private static final Map<String, String> RENAMES = ImmutableMap.builder()
...
/*    */ 
/*    */   
/* 68 */   public AdvancementsFix(Schema outputSchema, boolean changesType) { super(outputSchema, changesType, "AdvancementsFix", name -> (String)RENAMES.getOrDefault(name, name)); }
/*    */ }
