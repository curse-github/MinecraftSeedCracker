...
/*    */ 
/*    */   
/* 30 */   static <S, T> Rule<S, T> fromTerm(Term<S> child, RuleAction<S, T> action) { return new WrappedTerm(action, child); }
/*    */ 
/*    */ 
/*    */   
/* 34 */   static <S, T> Rule<S, T> fromTerm(Term<S> child, SimpleRuleAction<S, T> action) { return new WrappedTerm(action, child); } @FunctionalInterface
/*    */   public static interface RuleAction<S, T> {
/*    */     T run(ParseState<S> param1ParseState); } public static final class WrappedTerm<S, T> extends Record implements Rule<S, T> { private final Rule.RuleAction<S, T> action; private final Term<S> child;
/* 37 */     public WrappedTerm(Rule.RuleAction<S, T> action, Term<S> child) { this.action = action; this.child = child; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraf\\util\parsing\packrat\Rule.class
