...
/*    */   public static final class GameRuleUpdate<T> extends Record {
/*    */     private final GameRule<T> gameRule;
/*    */     private final T value;
/*    */     
/* 17 */     public GameRuleUpdate(GameRule<T> gameRule, T value) { this.gameRule = gameRule; this.value = value; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/* 17 */       //   0	7	0	this	Lnet/minecraft/server/jsonrpc/methods/GameRulesService$GameRuleUpdate<TT;>; } public GameRule<T> gameRule() { return this.gameRule; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable type table:
/*    */       //   start	length	slot	name	signature
/*    */       //   0	7	0	this	Lnet/minecraft/server/jsonrpc/methods/GameRulesService$GameRuleUpdate<TT;>; } public final boolean equals(Object o) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
...
/* 42 */     List<GameRuleUpdate<?>> rules = new ArrayList<GameRuleUpdate<?>>();
/*    */     
/* 44 */     minecraftApi.gameRuleService().getAvailableGameRules().forEach(gameRule -> 
/* 45 */         addGameRule(minecraftApi, gameRule, rules));
/*    */     
/* 47 */     return rules;
/*    */   }
/*    */   
/*    */   private static <T> void addGameRule(MinecraftApi minecraftApi, GameRule<T> gameRule, List<GameRuleUpdate<?>> rules) {
/* 51 */     T value = (T)minecraftApi.gameRuleService().getRuleValue(gameRule);
/* 52 */     rules.add(getTypedRule(minecraftApi, gameRule, Objects.requireNonNull(value)));
/*    */   }
/*    */ 
/*    */   
/* 56 */   public static <T> GameRuleUpdate<T> getTypedRule(MinecraftApi minecraftApi, GameRule<T> gameRule, T value) { return minecraftApi.gameRuleService().getTypedRule(gameRule, value); }
/*    */ 
/*    */ 
/*    */   
/* 60 */   public static <T> GameRuleUpdate<T> update(MinecraftApi minecraftApi, GameRuleUpdate<T> update, ClientInfo clientInfo) { return minecraftApi.gameRuleService().updateGameRule(update, clientInfo); }
/*    */ }


/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\server\jsonrpc\methods\GameRulesService.class
