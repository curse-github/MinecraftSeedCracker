...
/*     */   
/* 339 */   private PackEntry(String name, PackResources resources, Predicate<Identifier> filter) { this.name = name; this.resources = resources; this.filter = filter; } public String name() { return this.name; } public PackResources resources() { return this.resources; } public Predicate<Identifier> filter() { return this.filter; }
