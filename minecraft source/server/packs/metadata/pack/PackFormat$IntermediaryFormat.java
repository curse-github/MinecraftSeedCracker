...
/*     */   
/*  45 */   public IntermediaryFormat(Optional<PackFormat> min, Optional<PackFormat> max, Optional<Integer> format, Optional<InclusiveRange<Integer>> supported) { this.min = min; this.max = max; this.format = format; this.supported = supported; } public Optional<PackFormat> min() { return this.min; } public Optional<PackFormat> max() { return this.max; } public Optional<Integer> format() { return this.format; } public Optional<InclusiveRange<Integer>> supported() { return this.supported; }
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\server\packs\metadata\pack\PackFormat$IntermediaryFormat.class
