...
/*     */   
/*  39 */   public RangeInfo(float start, float end, Optional<Float> initial, Optional<Float> step) { this.start = start; this.end = end; this.initial = initial; this.step = step; } public float start() { return this.start; } public float end() { return this.end; } public Optional<Float> initial() { return this.initial; } public Optional<Float> step() { return this.step; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Curse\Desktop\servers\test\versions\1.21.11_unobfuscated\server-1.21.11_unobfuscated.jar!\net\minecraft\server\dialog\input\NumberRangeInput$RangeInfo.class
